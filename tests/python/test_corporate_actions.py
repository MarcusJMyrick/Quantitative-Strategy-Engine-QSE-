...
class TestSplitAdjustment:
    ...
    def test_multiple_splits_compound(self):
        ...
        df = bars(
            ["2014-06-06", "2020-08-28", "2020-08-31"], [644.0, 500.0, 125.0], [700, 1000, 4000]
        )
...
class TestDividendAdjustment:
    def test_proportional_backadjustment(self):
        ...
        df = bars(["2024-03-13", "2024-03-14", "2024-03-15"], [99.0, 100.0, 99.5], [1000] * 3)
