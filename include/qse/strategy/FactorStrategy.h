...
public:
     ...
     */
    FactorStrategy(std::shared_ptr<IOrderManager> order_manager, std::string symbol,
...
private:
    ...
    void
    compute_and_submit_delta_orders(const std::unordered_map<std::string, double>& close_prices);
