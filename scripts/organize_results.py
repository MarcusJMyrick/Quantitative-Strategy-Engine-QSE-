...
def copy_config_files(organized_dir):
    ...
    """
    organized_path = Path(organized_dir)
    config_files = ["config.yaml", "config/slippage.yaml", "requirements.txt", "CMakeLists.txt"]
...
def main():
    parser = argparse.ArgumentParser(
        description="Organize QSE trading results into a clean directory structure"
    )
    parser.add_argument(
        "--results-dir",
        default="results",
    ...
    parser.add_argument(
        "--plots-dir", default="plots", help="Directory containing plot files (default: plots)"
    )
    parser.add_argument(
        "--output-dir",
