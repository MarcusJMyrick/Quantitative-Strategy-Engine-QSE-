...
public:
     ...
     */
    PairsTradingStrategy(const std::string& symbol1, const std::string& symbol2, double hedge_ratio,
                         int spread_window, double entry_threshold, double exit_threshold,
