...
static std::shared_ptr<arrow::Table> build_multi_asset() {
    ...
    // Build Arrow columns
    arrow::StringBuilder db, ab;
    db.AppendValues(dates);
    ab.AppendValues(assets);
    arrow::DoubleBuilder rb, mb;
    rb.AppendValues(ret);
    mb.AppendValues(mkt);
    ...
    auto schema = arrow::schema(
        {arrow::field("date", arrow::utf8()), arrow::field("asset", arrow::utf8()),
         arrow::field("ret", arrow::float64()), arrow::field("mkt", arrow::float64())});
