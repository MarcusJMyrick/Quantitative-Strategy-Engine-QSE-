...
void Backtester::run() {
    ...
    trade_log_file << "timestamp,type,price,quantity,commission\n";
    // This assumes you have added get_trade_log() to your IOrderManager and OrderManager
    ...
    for (const auto& trade : trade_log) {
        ...
        trade_log_file << seconds.time_since_epoch().count() << ","
